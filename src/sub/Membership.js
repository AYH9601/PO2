  ...
  //에러 객체를 반환하는 함수
    const check = val=>{
        ...
        if( !val.pwd1 || val.pwd1.length<7 || !eng.test(val.pwd1) || !num.test(val.pwd1) || !spc.test(val.pwd1)){
            errs.pwd1='Password must be 7 or more characters, including letters, numbers, and special characters.';
        }
...
return (
    <main className='join' ref={frame}>
        <div className="inner">
            ...
            <h2>Join Umbrella and discover our training and technology</h2>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <label htmlFor='male'>BASIC</label>
                                <input 
                                    type="radio" 
                                    id='basic' 
                                    name='type' 
                                ...
                                <label htmlFor='femal'>STANDARD</label>
                                <input 
                                    type="radio" 
                                    id='standard' 
                                    name='type' 
                                ...
                                <label htmlFor='femal'>HYPER</label>
                                <input 
                                    type="radio" 
                                    id='hyper' 
                                    name='type' 
                                    onChange = {handleCheck} 
                                />
                                <span className='err'>{err.type}</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                <label htmlFor='sport'>Education</label>
                                <input 
                                    type="checkbox" 
                                    id='education' 
                                    name='aim' 
                                ...
                                <label htmlFor='music'>Technology</label>
                                <input 
                                    type="checkbox" 
                                    id='technology' 
                                    name='aim' 
                                ...
                                <label htmlFor='game'>Recruit</label>
                                <input 
                                    type="checkbox" 
                                    id='recruit' 
                                    name='aim' 
